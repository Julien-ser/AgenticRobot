...
char ssid_Router[]     = "JulWifi";
char password_Router[] = "Myworkstuff";
...
void loop() {
  ...
  if (client) {                                //if you get a client
    ...
    while (client.connected()) {
      ...
      // Emotion_and_Ultrasonic_Setup() intentionally removed from loop —
      // it was re-running Wire.begin() + I2C probe on every iteration,
      // slowing the loop and risking missed TCP commands. It runs once in setup().
      if (Check_Module_value == MATRIX_IS_EXIST) {
